export default {
  ...
  interpretation: {
    ...
    core_advice: {
      ...
      general_yang: '根据卦象，{upperName}在上，{lowerName}在下。外在环境或表现比较强势/主动，而内在基础（下卦{lowerName}）则{meaning}。建议内外兼修，顺势而为。',
      general_yin: '根据卦象，{upperName}在上，{lowerName}在下。外在环境或表现比较柔和/顺从，而内在基础（下卦{lowerName}）则{meaning}。建议内外兼修，顺势而为。'
    },
    core_guidance: '【核心指引】',
    moving_lines: {
      title: '【变爻分析与建议】',
      ...
      yao_text: '爻辞：{text}',
      no_yao_text: '（无爻辞）',
      analysis_template: '解析：{advice}在{topic}上，这意味着目前的变数关键点在于此阶段，请仔细体悟爻辞的启示。',
      position_1: '处于事物初期，地位卑微，不宜轻举妄动，应潜藏待机。',
      position_2: '处于下卦之中，得位，利于寻求支持或稳步发展。',
      position_3: '处于下卦之上，位置尴尬，需防躁动，谨慎行事。',
      position_4: '进入上卦初期，环境多变，容易恐惧或不安，需柔顺应对。',
      position_5: '处于尊位，虽然尊贵但也责任重大，需中正行事。',
      position_6: '处于亢极之位，物极必反，需防满盈招损，宜知进退。'
    }
  },
  ui: {
    hexagram: {
